# AGENTS.md — Constitución operativa del proyecto
...
|---|---|---|
| `observed` | Un hook del host vio el ciclo real de arranque y fin del subagente | `SubagentStart`/`SubagentStop` → `.claude/hooks/subagent-log.mjs` |
